"""Run obstacles.js tests headlessly via Playwright.

Usage: python tests/run_obstacles_headless.py
"""
import io
import os
import sys
...
@app.route("/")
def index():
    return send_from_directory(os.path.join(BASE, "tests"), "test_obstacles.html")
...
if __name__ == "__main__":
    ...
    with sync_playwright() as p:
        ...
        page.goto("http://127.0.0.1:5560", wait_until="networkidle")
